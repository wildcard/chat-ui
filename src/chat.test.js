...
describe('Chat', () => {
  ...
  it('send with socket', () => {
    ...
    expect(socketMock.emit.mock.calls[0][1]).toHaveProperty(
      'text',
      'test message'
    );
  });
